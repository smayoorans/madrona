...
<head>
    <title><decorator:title default="Welcome to MySchool"/></title>
    ...
    <link rel="stylesheet" type="text/css"
          href="<c:url value="/resources/admin-theme/css/bootstrap-responsive.min.css"/>"/>
    <!-- Add custom CSS here -->
...
<body>
<%@ include file="/WEB-INF/includes/login-navbar.jsp" %>
...
<script type="text/javascript" src="<c:url value="/resources/admin-theme/js/signin.js"/>"></script>
</body>
</html>
