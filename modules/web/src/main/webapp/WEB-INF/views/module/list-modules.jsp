...
<div class="span12">
    ...
    <div class="widget widget-nopad">
        <div class="widget-header"><i class="icon-list-alt"></i>
            ...
            <h3><fmt:message key="module.details.label"/></h3>
        </div>
        <!-- /widget-header -->
                ...
                <div class="widget-content">
                    <c:if test="${!empty moduleList}">
                        <table class="table table-bordered">
                            <tr>
                                <th><fmt:message key="common.admin.module.name"/></th>
                                <th><fmt:message key="common.admin.module.description"/></th>
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" data-toggle="modal">Suspend</a> ,
                                        <a href="#myModal" class="testing" role="button" data-toggle="modal"
                                           data-id="${module.id}">Delete</a> ,
                                        <a href="view-module?id=${module.id}">Modify</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
...
<script>
    $(document).on("click", ".testing", function () {
        ...
        document.getElementById("delete-link").href = "delete-module-action?id=" + moduleId;
