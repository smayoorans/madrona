...
<div class="span12">
    ...
    <div class="widget widget-nopad">
        <div class="widget-header"><i class="icon-list-alt"></i>
            ...
            <h3><fmt:message key="group.details.label"/></h3>
        </div>
        <!-- /widget-header -->
                ...
                <div class="widget-content">
                    <c:if test="${!empty groupList}">
                        <table class="table table-bordered">
                            <tr>
                                <th><fmt:message key="common.admin.group.name"/></th>
                                <th><fmt:message key="common.admin.group.description"/></th>
                            ...
                            <c:forEach items="${groupList}" var="group">
                                <tr>
                                    ...
                                    <td><a href="#" data-toggle="modal">Suspend</a> ,
                                        ...
                                        <a href="view-group?id=${group.id}">Modify</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
...
<script>
    $(document).on("click", ".testing", function () {
        ...
        document.getElementById("delete-link").href = "delete-group-action?id=" + groupId;
