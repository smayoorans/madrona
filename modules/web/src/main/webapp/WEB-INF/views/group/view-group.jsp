...
<fmt:bundle basename="messages">
    <head><title><fmt:message key="common.admin.view.group"/></title></head>
    <body>
    <br>
                ...
                <div class="span8">
                    <div class="widget">
                        ...
                        <div class="widget-header">
                            ...
                            <h3><fmt:message key="common.admin.view.group"/></h3>
                        </div>
                        <!-- /widget-header -->
                        ...
                        <div class="widget-content">
                            ...
                            <form:form id="add-group" class="form-horizontal" method="POST" action="update-group-action"
                                       commandName="group">
                                <fieldset>
