...
<html>
<head>
    <title><fmt:message key="user.details.label"/></title>
</head>
<body>
<div class="span12">
    ...
    <div class="widget widget-nopad">
        <div class="widget-header"><i class="icon-list-alt"></i>
            ...
            <h3><fmt:message key="user.details.label"/></h3>
        </div>
        <!-- /widget-header -->
                ...
                <div class="widget-content">
                    <c:if test="${!empty userList}">
                        <table class="table table-bordered">
                            <tr>
                                <th><fmt:message key="common.admin.user.username"/></th>
                                <th><fmt:message key="common.admin.user.password"/></th>
                            ...
                            <c:forEach items="${userList}" var="user">
                                <tr>
                                    ...
                                    <td><a href="#" data-toggle="modal">Suspend</a> ,
                                        ...
                                        <a href="view-user?id=${user.id}">Modify</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
...
<script>
    $(document).on("click", ".testing", function () {
        ...
        document.getElementById("delete-link").href = "delete-user-action?id=" + userId;
